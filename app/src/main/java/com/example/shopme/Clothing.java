...
public class Clothing extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mClothingList = rootView.findViewById(R.id.clothing_list);
        mClothingList.setHasFixedSize(true);
        mClothingList.setLayoutManager(new LinearLayoutManager(getActivity()));

        mDatabase = FirebaseDatabase.getInstance().getReference().child("ClothingTypes");
