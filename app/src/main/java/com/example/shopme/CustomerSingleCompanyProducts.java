...
public class CustomerSingleCompanyProducts extends AppCompatActivity {

    private RecyclerView msingleCompList ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_single_company_products);

        msingleCompList = (RecyclerView) findViewById(R.id.singleCompany_list);
        msingleCompList.setHasFixedSize(true);
        msingleCompList.setLayoutManager(new LinearLayoutManager(this));

        mAuth = FirebaseAuth.getInstance();

        compName = getIntent().getExtras().getString("CompName");
        ...
        mQueryCategory = mDatabase.orderByChild("CompnayName").equalTo(compName);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Product , SingleCompViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Product, SingleCompViewHolder>(

                Product.class ,
                R.layout.clothing_row ,
                SingleCompViewHolder.class ,
                mQueryCategory

        ) {
            @Override
            protected void populateViewHolder(SingleCompViewHolder viewHolder, final Product model, int position) {
        ...
        msingleCompList.setAdapter(firebaseRecyclerAdapter);
    }

    public static class SingleCompViewHolder extends RecyclerView.ViewHolder{
        ...
        public SingleCompViewHolder(View itemView) {
            super(itemView);
