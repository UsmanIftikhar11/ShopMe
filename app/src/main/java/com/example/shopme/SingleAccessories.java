...
public class SingleAccessories extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_accessories);

        productType = getIntent().getExtras().getString("Type");

        mAccessoriesList = (RecyclerView) findViewById(R.id.singleAccessories_list);
        mAccessoriesList.setHasFixedSize(true);
        mAccessoriesList.setLayoutManager(new LinearLayoutManager(this));
        ...
        mQueryCategory = mDatabase.orderByChild("Type").equalTo(productType);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Product , SingleAccessoriesViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Product, SingleAccessoriesViewHolder>(

                Product.class ,
                R.layout.clothing_row ,
                SingleAccessoriesViewHolder.class ,
                mQueryCategory

        ) {
            @Override
            protected void populateViewHolder(SingleAccessoriesViewHolder viewHolder, final Product model, int position) {
    ...
    public static class SingleAccessoriesViewHolder extends RecyclerView.ViewHolder{
        ...
        public SingleAccessoriesViewHolder(View itemView) {
            super(itemView);
