...
public class SingleClothing extends AppCompatActivity {

    private RecyclerView mClothingList ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_clothing);

        productType = getIntent().getExtras().getString("Type");

        mClothingList = (RecyclerView) findViewById(R.id.singleClothing_list);
        mClothingList.setHasFixedSize(true);
        mClothingList.setLayoutManager(new LinearLayoutManager(this));
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Product , SingleClothingViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Product, SingleClothingViewHolder>(

                Product.class ,
                R.layout.clothing_row ,
                SingleClothingViewHolder.class ,
                mQueryCategory

        ) {
            @Override
            protected void populateViewHolder(SingleClothingViewHolder viewHolder, final Product model, int position) {
        ...
        mClothingList.setAdapter(firebaseRecyclerAdapter);
    }

    public static class SingleClothingViewHolder extends RecyclerView.ViewHolder{
        ...
        public SingleClothingViewHolder(View itemView) {
            super(itemView);
