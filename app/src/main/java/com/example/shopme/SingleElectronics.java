...
public class SingleElectronics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_electronics);

        productType = getIntent().getExtras().getString("Type");

        mElectronicsList = (RecyclerView) findViewById(R.id.singleElectronics_list);
        mElectronicsList.setHasFixedSize(true);
        mElectronicsList.setLayoutManager(new LinearLayoutManager(this));
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Product , SingleElectronicsViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Product, SingleElectronicsViewHolder>(

                Product.class ,
                R.layout.clothing_row ,
                SingleElectronicsViewHolder.class ,
                mQueryCategory

        ) {
            @Override
            protected void populateViewHolder(SingleElectronicsViewHolder viewHolder, final Product model, int position) {
    ...
    public static class SingleElectronicsViewHolder extends RecyclerView.ViewHolder{
        ...
        public SingleElectronicsViewHolder(View itemView) {
            super(itemView);
